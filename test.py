from syllabus_pdf_generator import generate_syllabus_pdf
from syllabus_pdf_generator import combine_syllabi_pdfs
syllabus_data = {
    "year": "2022",
    "program": "MCA",
...
pdf_bytes = generate_syllabus_pdf(syllabus_data)
...
pdf_bytes = combine_syllabi_pdfs(syllabi_data)

pdf_path = "combined_syllabus.pdf"
with open(pdf_path, "wb") as f:
    f.write(pdf_bytes)
